...
-- Seed Products
INSERT INTO public.products (id, product_code, name, sku, category, current_stock, min_stock_level, stock_in, stock_out, available_stock, reserved_stock, supplier, price)
VALUES
    ('PRD-101', 'AUC-101', 'Auco Industrial Automation Controller X1', 'AUC-AC-101-IND', 'Automation Hardware', 48, 15, 80, 32, 45, 3, 'Auco Robotics Hub, Pune', 45000),
    ('PRD-102', 'AUC-202', 'Auco Smart Sensor Array - Dual Channel', 'AUC-SN-202-DC', 'Sensors & IOT', 120, 25, 200, 80, 110, 10, 'Apex Electronics, Bengaluru', 12500),
    ('PRD-103', 'AIW-301', 'Aiwa High-Precision Sound Calibration Kit', 'AIW-SC-301-PRO', 'Acoustics & Testing', 14, 10, 25, 11, 12, 2, 'Aiwa Global Tech, Japan/India', 85000),
    ('PRD-104', 'AIW-405', 'Aiwa Commercial Audio Matrix Switcher 8x8', 'AIW-MX-405-8X', 'Commercial AV', 8, 10, 20, 12, 6, 2, 'Aiwa Global Tech, New Delhi', 64000),
    ('PRD-105', 'AUC-550', 'Auco IoT Gateway & Edge Telemetry Unit', 'AUC-GW-550-EDG', 'Edge Computing', 35, 12, 50, 15, 30, 5, 'Auco Dynamics, Hyderabad', 28000),
    ('PRD-106', 'AIW-800', 'Aiwa Studio Acoustic Analyzer V4', 'AIW-AN-800-V4', 'Acoustics & Testing', 5, 8, 15, 10, 3, 2, 'Aiwa Precision Labs, Mumbai', 112000),
    ('PRD-107', 'AUC-900', 'Auco Annual Enterprise Maintenance SLA', 'AUC-SRV-SLA-YR', 'Services', 999, 0, 999, 45, 954, 0, 'Auco Services Div, Gurugram', 36000)
ON CONFLICT (id) DO NOTHING;

-- Seed Clients
INSERT INTO public.clients (id, client_name, company_name, contact_person, phone, email, address, city, state, client_type, lead_source, lead_type, conversion_status, assigned_sales_person, total_orders, order_frequency, last_order, next_expected_order, payment_terms, payment_days, pending_amount, total_business_value, notes, client_status)
VALUES
    ('CLN-001', 'Sunil Mehta', 'Mehta Precision Engineering Ltd', 'Sunil Mehta (MD)', '+91 98220 14589', 'sunil@mehtaprecision.in', 'Plot 42, MIDC Bhosari Industrial Estate', 'Pune', 'Maharashtra', 'Enterprise', 'Exhibition', 'Inbound', 'Converted', 'Vikram Malhotra', 6, 'Monthly', '2026-08-15', '2026-09-15', 'Net 30', 30, 45000, 480000, 'Key manufacturing client. Regular consumer of AUC-101 and AUC-202.', 'Active'),
    ('CLN-002', 'Ananya Roy', 'Bengal Broadcast & Media Studios', 'Ananya Roy (CTO)', '+91 98310 99881', 'ananya.roy@bengalbroadcast.com', 'Sector V, Salt Lake Electronics Complex', 'Kolkata', 'West Bengal', 'Enterprise', 'WhatsApp', 'Inbound', 'Converted', 'Priya Desai', 3, 'Quarterly', '2026-07-28', '2026-10-20', 'Net 15', 15, 0, 340000, 'Premium studio installation client. Standardizes on Aiwa audio matrices.', 'Active'),
    ('CLN-003', 'Karthik Ramanathan', 'Deccan Automations & Robotics', 'Karthik Ramanathan (Procurement)', '+91 98401 22987', 'karthik@deccanauto.in', 'SIPCOT IT Park, Siruseri, OMR', 'Chennai', 'Tamil Nadu', 'Enterprise', 'Referral', 'Partner', 'Converted', 'Vikram Malhotra', 8, 'Monthly', '2026-08-20', '2026-09-20', 'Net 30', 30, 118000, 890000, 'Strategic tier-1 client. Has an active overdue invoice.', 'Active'),
    ('CLN-004', 'Rohit Khandelwal', 'Jaipur Smart Infrastructure Corp', 'Rohit Khandelwal (VP Tech)', '+91 98290 33412', 'rohit@jaipursmartinfra.com', 'Sitapura Industrial Area, Tonk Road', 'Jaipur', 'Rajasthan', 'SME', 'Website', 'Inbound', 'Converted', 'Priya Desai', 2, 'Quarterly', '2026-06-10', '2026-09-05', 'Net 15', 15, 0, 156000, 'Smart city sub-contractor utilizing Auco Edge IoT gateways.', 'Active'),
    ('CLN-005', 'Gaurav Bhatia', 'NCR Logistics & Warehousing Hub', 'Gaurav Bhatia (Operations)', '+91 98100 44521', 'gbhatia@ncrlogistics.com', 'Udyog Vihar Phase IV', 'Gurugram', 'Haryana', 'Enterprise', 'Cold Call', 'Outbound', 'Converted', 'Vikram Malhotra', 4, 'Bi-weekly', '2026-08-22', '2026-09-08', 'Net 30', 30, 64000, 520000, 'High volume IoT tracking deployment.', 'Active'),
    ('CLN-006', 'Harish Nambiar', 'Cochin Marine & Industrial Systems', 'Harish Nambiar (GM)', '+91 98470 55678', 'harish@cochinmarine.in', 'Willingdon Island Commercial Zone', 'Kochi', 'Kerala', 'Distributor', 'Exhibition', 'Inbound', 'Converted', 'Priya Desai', 3, 'Quarterly', '2026-05-18', '2026-09-12', 'Net 45', 45, 32000, 275000, 'Marine acoustic testing partner.', 'Active'),
    ('CLN-007', 'Naveen Reddy', 'Cyberabad Tech Parks AV Facilities', 'Naveen Reddy (AV Lead)', '+91 98490 66789', 'naveen.r@cyberabadparks.com', 'HITEC City, Madhapur', 'Hyderabad', 'Telangana', 'Enterprise', 'WhatsApp', 'Inbound', 'Converted', 'Vikram Malhotra', 5, 'Monthly', '2026-08-18', '2026-09-18', 'Net 30', 30, 0, 610000, 'Large auditorium installations using Aiwa switchers.', 'Active'),
    ('CLN-008', 'Bhavin Shah', 'Gujarat Precision Tools & Dies', 'Bhavin Shah (Partner)', '+91 98250 88912', 'bhavin@gjprecision.com', 'GIDC Vatva Industrial Area', 'Ahmedabad', 'Gujarat', 'SME', 'Website', 'Inbound', 'Converted', 'Priya Desai', 4, 'Monthly', '2026-08-05', '2026-09-05', 'Net 30', 30, 0, 390000, 'Consistent automation upgrade customer.', 'Active')
ON CONFLICT (id) DO NOTHING;

-- Seed Leads
INSERT INTO public.leads (id, client, company, phone, email, city, state, lead_source, lead_type, assigned_salesperson, follow_up_date, last_contact, next_action, stage, expected_value, conversion_status, conversion_date, conversion_percentage, lead_date, notes, whatsapp_status)
VALUES
    ('LEAD-001', 'Nandini Swaminathan', 'Bangalore Aero & Defense Dynamics', '+91 98450 11990', 'nandini.s@bengaluru-aero.com', 'Bengaluru', 'Karnataka', 'WhatsApp', 'Inbound', 'Vikram Malhotra', '2026-08-28', '2026-08-26', 'Demo acoustic calibration kit with engineering team', 'Negotiation', 240000, 'Not Converted', null, 80, '2026-08-10', 'Wants 2x AIW-800 Analyzers. Pricing agreed.', 'Recent conversation active'),
    ('LEAD-002', 'Deepak Chawla', 'Noida Electronics Assembly Line', '+91 98180 77443', 'deepak.c@noidaelectronics.com', 'Noida', 'Uttar Pradesh', 'Website', 'Inbound', 'Priya Desai', '2026-08-29', '2026-08-25', 'Send formal quote for 10x AUC-101 Controllers', 'Proposal', 450000, 'Not Converted', null, 60, '2026-08-14', 'Expanding SMT assembly lines.', 'Quote request on WhatsApp'),
    ('LEAD-003', 'Manish Tiwari', 'Indore Auto Component Manufacturers', '+91 98260 22345', 'm.tiwari@indoreauto.in', 'Indore', 'Madhya Pradesh', 'Cold Outreach', 'Outbound', 'Vikram Malhotra', '2026-08-30', '2026-08-24', 'Introductory technical call with plant manager', 'Qualified', 180000, 'Not Converted', null, 40, '2026-08-18', 'Interested in smart vibration sensors.', 'Brochure PDF shared'),
    ('LEAD-004', 'Sanjay Aggarwal', 'Ludhiana Textiles Automated Looms', '+91 98150 99112', 'sanjay@ludhianatex.com', 'Ludhiana', 'Punjab', 'Referral', 'Partner', 'Priya Desai', '2026-09-02', '2026-08-22', 'Qualify machinery specifications', 'Contacted', 310000, 'Not Converted', null, 25, '2026-08-20', 'Modernizing loom units with edge telemetry.', 'Pending reply on WhatsApp'),
    ('LEAD-005', 'Rameshwar Soni', 'Navi Mumbai Media Complex', '+91 98200 88231', 'rameshwar@nmmediacomplex.com', 'Navi Mumbai', 'Maharashtra', 'WhatsApp', 'Inbound', 'Vikram Malhotra', '2026-08-27', '2026-08-27', 'Close purchase order and confirm delivery', 'Won', 192000, 'Converted', '2026-08-27', 100, '2026-08-08', 'Approved PO for 3x Matrix Switchers.', 'PO confirmation sent via WhatsApp')
ON CONFLICT (id) DO NOTHING;

-- Seed Orders
INSERT INTO public.orders (id, client_id, client_name, items, product_code, quantity, order_value, order_date, delivery_status, payment_status, invoice_id, assigned_team_member)
VALUES
    ('ORD-1001', 'CLN-001', 'Mehta Precision Engineering Ltd', '[{"name": "Auco Industrial Automation Controller X1", "price": 45000, "total": 90000, "quantity": 2, "productCode": "AUC-101"}, {"name": "Auco Smart Sensor Array - Dual Channel", "price": 12500, "total": 50000, "quantity": 4, "productCode": "AUC-202"}]'::jsonb, 'AUC-101, AUC-202', 6, 140000, '2026-08-15', 'Delivered', 'Partially Paid', 'INV-2026-001', 'Sneha Kulkarni'),
    ('ORD-1002', 'CLN-003', 'Deccan Automations & Robotics', '[{"name": "Auco Industrial Automation Controller X1", "price": 45000, "total": 90000, "quantity": 2, "productCode": "AUC-101"}, {"name": "Auco IoT Gateway & Edge Telemetry Unit", "price": 28000, "total": 28000, "quantity": 1, "productCode": "AUC-550"}]'::jsonb, 'AUC-101, AUC-550', 3, 118000, '2026-08-20', 'In Progress', 'Unpaid', 'INV-2026-002', 'Rahul Verma'),
    ('ORD-1003', 'CLN-005', 'NCR Logistics & Warehousing Hub', '[{"name": "Aiwa Commercial Audio Matrix Switcher 8x8", "price": 64000, "total": 64000, "quantity": 1, "productCode": "AIW-405"}]'::jsonb, 'AIW-405', 1, 64000, '2026-08-22', 'In Progress', 'Unpaid', 'INV-2026-003', 'Sneha Kulkarni')
ON CONFLICT (id) DO NOTHING;

-- Seed Invoices
INSERT INTO public.invoices (id, invoice_number, order_id, client_id, client_name, contact_person, email, phone, billing_address, items, subtotal, tax_rate, tax_amount, total_amount, amount_paid, balance, payment_status, issue_date, payment_due_date, payment_terms, notes)
VALUES
    ('INV-2026-001', 'INV-2026-001', 'ORD-1001', 'CLN-001', 'Mehta Precision Engineering Ltd', 'Sunil Mehta (MD)', 'sunil@mehtaprecision.in', '+91 98220 14589', 'Plot 42, MIDC Bhosari Industrial Estate, Pune, Maharashtra - 411026', '[{"name": "Auco Industrial Automation Controller X1", "price": 45000, "total": 90000, "taxRate": 18, "quantity": 2, "productCode": "AUC-101"}, {"name": "Auco Smart Sensor Array - Dual Channel", "price": 12500, "total": 50000, "taxRate": 18, "quantity": 4, "productCode": "AUC-202"}]'::jsonb, 140000, 18, 25200, 165200, 120200, 45000, 'Partially Paid', '2026-08-15', '2026-09-14', 'Net 30', 'Advance received ₹1,20,200.'),
    ('INV-2026-002', 'INV-2026-002', 'ORD-1002', 'CLN-003', 'Deccan Automations & Robotics', 'Karthik Ramanathan', 'karthik@deccanauto.in', '+91 98401 22987', 'SIPCOT IT Park, Siruseri, OMR, Chennai, Tamil Nadu - 603103', '[{"name": "Auco Industrial Automation Controller X1", "price": 45000, "total": 90000, "taxRate": 18, "quantity": 2, "productCode": "AUC-101"}, {"name": "Auco IoT Gateway & Edge Telemetry Unit", "price": 28000, "total": 28000, "taxRate": 18, "quantity": 1, "productCode": "AUC-550"}]'::jsonb, 118000, 18, 21240, 139240, 0, 139240, 'Overdue', '2026-07-20', '2026-08-19', 'Net 30', 'Overdue by 8 days.')
ON CONFLICT (id) DO NOTHING;

-- Seed Payments
INSERT INTO public.payments (id, invoice_id, invoice_number, client_id, client_name, invoice_amount, amount_paid, balance, payment_date, payment_due_date, payment_days, payment_status, payment_mode)
VALUES
    ('PAY-001', 'INV-2026-001', 'INV-2026-001', 'CLN-001', 'Mehta Precision Engineering Ltd', 165200, 120200, 45000, '2026-08-16', '2026-09-14', 30, 'Partially Paid', 'NEFT'),
    ('PAY-002', 'INV-2026-002', 'INV-2026-002', 'CLN-003', 'Deccan Automations & Robotics', 139240, 0, 139240, null, '2026-08-19', 30, 'Overdue', 'Pending')
ON CONFLICT (id) DO NOTHING;

-- Seed Tasks
INSERT INTO public.tasks (id, task_name, description, assigned_person, client, priority, due_date, status, created_by, created_at, notes)
VALUES
    ('TSK-001', 'Deploy On-site Commissioning Team at Bhosari', 'Install and configure 2x Auco X1 controllers.', 'Sneha Kulkarni', 'Mehta Precision Engineering Ltd', 'High', '2026-08-29', 'In Progress', 'Rajesh Sharma (Admin)', '2026-08-24', 'Pre-flight check completed.'),
    ('TSK-002', 'Dispatch Urgent Stock to Chennai Facility', 'Ensure 2x AUC-101 and 1x AUC-550 are packed.', 'Rahul Verma', 'Deccan Automations & Robotics', 'Urgent', '2026-08-27', 'In Progress', 'Rajesh Sharma (Admin)', '2026-08-25', 'AWB generated.')
ON CONFLICT (id) DO NOTHING;

-- Seed Follow-ups
INSERT INTO public.followups (id, client_id, client_name, contact_person, phone, assigned_salesperson, follow_up_date, follow_up_type, notes, next_action, status)
VALUES
